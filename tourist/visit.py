...
@router.delete("/api/tourist/tour/booking/delete")
...
@router.get("/api/tourist/tour/booked")
...
@router.get("/api/tourist/tour/location")
def show_location(tid: UUID):
    return tours_locations[tid]

@router.get("/api/tourist/tour/available")
