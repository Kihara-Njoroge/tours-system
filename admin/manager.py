...
@router.post("/api/admin/destination/add")
...
@router.delete("/api/admin/destination/remove/{id}")
...
@router.put("/api/admin/destination/update", status_code=status.HTTP_202_ACCEPTED)
...
@router.get("/api/admin/destination/list", status_code=status.HTTP_200_OK)
def list_all_tours():
    return tours

@router.get("/api/admin/tourists/list")
def list_all_tourists():
    return approved_users

@router.get("/api/admin/tourists/pending/list")
def list_all_pending():
    return pending_users

@router.get("/api/admin/tourists/vip")
...
@router.post("/api/admin/user/login/approve")
